...
class MenuApp:
    def __init__(self, master):
        self.master = master
        self.create_menu()
        self.nombreArchivo = "./media/quinto/UBUNTU%2022_0/prueba.xlsx"
    ...
    def create_menu(self):
        ...
        menu_calc.add_command(label="Promedio", command=self.show_all)
        menu_calc.add_command(label="Mediana", command=self.show_name)
        menu_calc.add_command(label="Moda", command=self.show_over_18)
